...
public class UserFilterValidator {
	...
	public String getPreviousValues(String filterName, String interestIdAsString, String cityIdAsString,
			String genderIdAsString, String ageFromAsString, String ageToAsString) {
		try {
