...
public class UpdateUserBalancePreparedStatementWriter implements Preparedstatementwriter<UserBalance> {

	private final UserBalance userBalance;

	public UpdateUserBalancePreparedStatementWriter(UserBalance userBalance) {
